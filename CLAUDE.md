# Claude Code Instructions: FFC-IN-freeforcharity.org

Welcome, Claude! This document provides specific instructions for working on FFC-IN-freeforcharity.org.
...
| `pnpm run test`  | Playwright launches browsers; needs time           |
