        ...
        <div className="w-[90%] md:w-[80%] max-w-[900px] mx-auto">
          <div className="space-y-6 mb-12" id="lato-font">
            <p className="text-[18px] font-[500] leading-[28px] text-[#333]">
              A nonprofit organization is the coming together of some groups of
              people for a purpose other than generating profit. And no part of
              the management income is shared or distributed to its members.
            </p>

            <p className="text-[18px] font-[500] leading-[28px] text-[#333]">
              How can they exist without profit? Case studies help us better
              understand.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <p
              ...
              id="lato-font"
            >
              What is a charity case study? It is a set of skills-based
              volunteer studies to answer the numerous questions people might
              have, accomplished by looking at real-life examples.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {studyTopics.map((topic) => (
                ...
                >
                  ...
                  <p
                    className="text-[16px] font-[500] text-[#333]"
                    id="lato-font"
                  >
                    {topic}
                  </p>
          ...
          <div className="space-y-6" id="lato-font">
            <p className="text-[18px] font-[500] leading-[28px] text-[#333]">
              You will not want to keep experimenting with the resources of your
              organization. You might end up getting what works but in most
              cases you might end up wasting your organization&apos;s money and
              precious time.
            </p>

            <p className="text-[18px] font-[500] leading-[28px] text-[#333]">
              A charity or nonprofit case study is a document that saves you
              money by helping the nonprofit management understand the
              competition. It also allows them a real choice without
              &quot;trial and error&quot; of every solution or method.
            </p>

            <p className="text-[18px] font-[500] leading-[28px] text-[#333]">
              Free for Charity has built these nonprofit charity case studies to
              help many nonprofit organizations in making a rightful decision
              without wasting time and money on experimentation.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-[50px] bg-[#2583ab]">
        <div className="w-[90%] md:w-[80%] max-w-[900px] mx-auto text-center">
          ...
          <p
            ...
            id="lato-font"
          >
            Contact us if you have a particular case study request or want to be
