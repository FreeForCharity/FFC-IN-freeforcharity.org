...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: "/charity-and-nonprofit-service-and-consultant-directory", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/charity-and-nonprofit-technology-directory", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/charity-and-nonprofit-case-studies", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/501c3", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/pre501c3", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/free-for-charity-endowment-fund", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/guidestar-guide", priority: 0.6, changeFrequency: "monthly" as const },
    { path: "/free-for-charitys-tools-for-success", priority: 0.6, changeFrequency: "monthly" as const },
    { path: "/free-for-charity-ffc-service-delivery-stages", priority: 0.6, changeFrequency: "monthly" as const },
    { path: "/free-for-charity-ffc-web-developer-training-guide", priority: 0.5, changeFrequency: "monthly" as const },
    { path: "/ffc-volunteer-proving-ground-core-competencies", priority: 0.5, changeFrequency: "monthly" as const },
    { path: "/charity-validation-guide-ensuring-mutual-benefit-through-comprehensive-validation-processes", priority: 0.5, changeFrequency: "monthly" as const },
    { path: "/online-impacts-onboarding-guide", priority: 0.5, changeFrequency: "monthly" as const },
    ...
    { path: "/free-for-charity-donation-policy", priority: 0.3, changeFrequency: "yearly" as const },
