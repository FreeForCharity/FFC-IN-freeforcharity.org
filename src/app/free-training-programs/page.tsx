...
const programs = [
  ...
  },
  {
    ...
    subtitle:
      "Online and offline business analyst training program",
  ...
  },
  {
    ...
    subtitle:
      "Website, web application, web development training program",
    level: "Entry to high-level program",
    description:
      ...
      <section className="py-[60px] bg-[#fcfcfc]">
        <div className="w-[90%] md:w-[80%] max-w-[1000px] mx-auto">
          ...
          <p
            ...
            id="lato-font"
          >
            At Free for Charity the projects you will work on while training
            and expanding your skills will help both Free for Charity directly
            and the assisted charities that we work with. It is truly a
            win-win-win.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-[10px] shadow-[0px_2px_12px_0px_rgba(0,0,0,0.08)] p-6 text-center">
              ...
              <h3 className="text-[18px] font-[700] text-[#2583ab] mb-2">
                You Win
              </h3>
              <p className="text-[15px] font-[500] text-[#333]" id="lato-font">
                Get training and skills in real work needed by for-profit and
                nonprofits alike.
              </p>
            </div>
            <div className="bg-white rounded-[10px] shadow-[0px_2px_12px_0px_rgba(0,0,0,0.08)] p-6 text-center">
              ...
              <p className="text-[15px] font-[500] text-[#333]" id="lato-font">
                Instead of your work never being seen again after training, your
                projects are all real-world things needed today.
              </p>
            </div>
            <div className="bg-white rounded-[10px] shadow-[0px_2px_12px_0px_rgba(0,0,0,0.08)] p-6 text-center">
              <div className="text-[40px] mb-2">&#127775;</div>
              ...
              <p className="text-[15px] font-[500] text-[#333]" id="lato-font">
                Free for Charity captures your skills and motivation to bring
                efficiencies to the nonprofit industry as a whole.
              </p>
            </div>
          </div>
        </div>
            ...
            {programs.map((program) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                  <h3 className="text-[26px] font-[700] text-[#2583ab]">
                    {program.title}
                  </h3>
                ...
                <p className="text-[16px] font-[600] text-[#555] italic mb-4">
                  {program.subtitle}
                </p>
