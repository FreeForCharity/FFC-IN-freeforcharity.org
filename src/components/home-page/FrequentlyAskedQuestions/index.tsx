        ...
        <div>
          ...
          <FrequentlyAskedQuestions title="Is there a need for a charity to provide help for charities?">
            <p className="mb-[30px]">
              ...
              companies to do work every day or buy products at full cost. Some do so without
              knowing that as a charity they qualify for lower rates or even free services from
              major companies. Others because it is hard to find the free products needed though the
